...
$GetExpenseHistory = "SELECT bills.*, 
                        ...
                        LEFT JOIN user ON bills.UserId = user.UserId
                            ...
                            <tbody>
                                <?php while ($col = mysqli_fetch_assoc($ExpenseHistory)) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $col['DepartmentName']; ?></td> <!-- Department Name -->
                                        <td><?php echo $col['FirstName']; ?></td> <!-- Displaying User's First Name -->
                                        ...
                                        <td colspan="2" class="notification">
                                            ...
                                            <a href="#DeleteEx<?php echo $col['BillsId']; ?>" data-toggle="modal"><span
                                                    ...
                                                    data-original-title="<?php echo $DeleteExpenses; ?>"></span></a>
                                        </td>
                                    </tr>
                                </tbody>
