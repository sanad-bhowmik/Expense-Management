...
$GetAllBillsDate = "SELECT SUM(Amount) AS Amount FROM bills WHERE MONTH(Dates) = MONTH(CURRENT_DATE())";
...
$GetAllBillsToday = "SELECT SUM(Amount) AS Amount FROM bills WHERE Dates = CURRENT_DATE()";
                            ...
                            <div class="form-group d-flex align-items-end gap-2 flex-wrap" style="display: flex; gap: 10px;">
                                ...
                                <div class="d-flex align-items-end">
                                    <button class="btn btn-primary" name="searchbtn" type="submit"
                                        style="margin-top: 26px;"><i class="fa fa-search"></i> </button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (!empty($col['file_path'])) {
                                                // Assuming 'file_path' contains only the relative path, e.g., 'BL_Flowchart.png'
